(function(global){
  ...
  var ILC = global.ILC = global.ILC || {languages: {}};
  ...
  ILC.convert = function print_many_words(text, lang_code) {
    var lang_data = ILC.languages[lang_code];
  ...
  ILC.addLanguage = function(langdata){
      ILC.languages[langdata.code] = langdata;
  };
